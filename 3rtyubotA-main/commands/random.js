...
module.exports = {
  ...
  async execute(interaction) { // ✅ client を削除して interaction のみに統一
    ...
    const allSets = [
      ...
      { name: '難易度33', items: ['	ロストワンの号哭', '初音天地開闢神話', 'ゴーストルール','ぼくらの16bit戦争','MarbleBlue.','嬢王','生命性シンドロウム','プラネットヒーロー','超ナイト・オブ・ナイツ','SAN値直葬','トレジャーガーデン'] },
