...
module.exports = {
  ...
  async execute(interaction) { // ✅ client を削除して interaction のみに統一
    ...
    const allSets = [
      ...
      { name: '難易度28', items: ['ハッピーシンセサイザ','ツギハギスタッカート','フラジール','シャルル','Just Be Friends','Hand in Hand','39みゅーじっく！','乙女解剖','ウミユリ海底譚','Forward','恋愛裁判','とても痛い痛がりたい','ヒビカセ','Color of Drops','ワンスアポンアドリーム','みくみくにしてあげる♪【してやんよ】','威風堂々','アイディスマイル','ロミオとシンデレラ','トラフィック・ジャム','フロムトーキョー','トキヲ・ファンカ','ワールドワイドワンダー','去り人達のワルツ','ミライ','ガランド','トリコロージュ','うっせぇわ','愛して愛して愛して','Peaky Peaky','ジウダス','心予報','僕らまだアンダーグラウンド','いーあるふぁんくらぶ','踊れオーケストラ','こちら、幸福安心委員会です。','帝国少女','Change me','パラジクロロベンゼン','陽だまりのセツナ','仮死化','夜もすがら君想ふ','天使の翼。','アイロニ','1925','ひつじがいっぴき','Hello, Worker','ココロ','ストロボラスト','パレットには君がいっぱい','Q','Highlight','絶え間なく藍色','命ばっかり','円尾坂の仕立屋','悪徳のジャッジメント','Wonder Style','太陽系デスコ','心拍ペアリング','演劇','星を繋ぐ','我らステインバスターズ！','サマータイムレコード','ボトルケーキ','Un-Lock','ラッキー☆オーブ','豚になってyeah yeah','Dear','CR詠ZY','purpose','Beyond the way','強風オールバック','エンヴィーベイビー','『んっあっあっ。』','ハイドアンド・シーク','古書屋敷殺人事件','JUMPIN’ OVER !','インテグラル','ド屑','明鏡止水','1000年生きてる','ガーネットの涙','だんだん早くなる','私は雨','酔いどれ知らず','抜錨','きょうもハレバレ','Supernova','LEADER','ULTRA C','林檎売りの泡沫少女','マインドブランド','WAVE','夏夜ノ唄','カルチャ','Unpoison','きみとぼくのレゾナンス','キャットフード','ぼくのかみさま','はじまりの未来','CH4NGE','サイハテ','夏に透明','Worlders','スマイル*シンフォニー','ハローセカイ','アンチユー','ルーマー','三日月ステップ','Sympathy','Call!!','花に風','光線歌','Twilight Melody','ありのままのストーリーを','ラストラス','8.32','あの夏が飽和する。','金時計'] },
